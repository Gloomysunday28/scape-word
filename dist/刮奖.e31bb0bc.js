...
function () {
  ...
  _createClass(Scrap, [{
    ...
    value: function judgeIsEnd() {
      var image = this.ctx.getImageData(0, 0, this.width, this.height); // 转换为base64进制

      var prvData = image.data; // 获取像素点， prv[n]代表r, prv[n + 1]代表g, prv[n + 2]代表b, prv[3 + n]代表a 
...
//# sourceMappingURL=/刮奖.e31bb0bc.js.map